<?php
/*
Template Name: Sponsor Logos Local
*/
get_header(); ?>
		...
		<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
			...
			<section class="sponsor-levels">
				...
				<div class="row diamond-sponsors">
					<?php $my_query = new WP_Query('cat=322&post_type=sponsors&orderby=menu_order&order=ASC'); ?>
			...
			<section class="sponsor-levels">
				...
				<div class="row platnum-sponsors">
					<?php $my_query = new WP_Query('cat=323&post_type=sponsors&orderby=menu_order&order=ASC'); ?>
					<?php while ($my_query->have_posts()): $my_query->the_post(); ?>
						<?php
							$sponsor_logo = get_field('sponsor_logo');
							$sponsor_name = get_field('sponsor_name');
			...
			<section class="sponsor-levels">
				...
				<div class="row gold-sponsors">
					<?php $my_query = new WP_Query('cat=324&post_type=sponsors&orderby=menu_order&order=ASC'); ?>
					<?php while ($my_query->have_posts()): $my_query->the_post(); ?>
						<?php
							$sponsor_logo = get_field('sponsor_logo');
							$sponsor_name = get_field('sponsor_name');
			...
			<section class="sponsor-levels">
				...
				<div class="row silver-sponsors">
					<?php $my_query = new WP_Query('cat=325&post_type=sponsors&orderby=menu_order&order=ASC'); ?>
					<?php while ($my_query->have_posts()): $my_query->the_post(); ?>
						<?php
							$sponsor_logo = get_field('sponsor_logo');
							$sponsor_name = get_field('sponsor_name');
			...
			<section class="sponsor-levels">
				...
				<div class="row bronze-sponsors">
					<?php $my_query = new WP_Query('cat=326&post_type=sponsors&orderby=menu_order&order=ASC'); ?>
					<?php while ($my_query->have_posts()): $my_query->the_post(); ?>
						<?php
							$sponsor_logo = get_field('sponsor_logo');
							$sponsor_name = get_field('sponsor_name');
			...
			<section class="sponsor-levels">
				...
				<div class="row agency-foundation-partners">
					<?php $my_query = new WP_Query('cat=327&post_type=sponsors&orderby=menu_order&order=ASC'); ?>
					<?php while ($my_query->have_posts()): $my_query->the_post(); ?>
						<?php
							$sponsor_logo = get_field('sponsor_logo');
							$sponsor_name = get_field('sponsor_name');
