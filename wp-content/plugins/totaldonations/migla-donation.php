...
//Honoree's letter
 ...
 ////////VERSION/////////////////////////////
 miglainit_option('migla_install', '1.7.0.'.time() ) ;
...
////CORS FALSE ALARM///////////////////
 ...
 miglainit_option('migla_show_bar', 'yes');
  ...
  /*** STRIPE ****/
   ...
   miglainit_option( 'migla_circle_text3', 'Backer');
            ...
            /********Thank You page ***********************/
			 ...
			 $trimquote = str_replace( '\"', '' , $str );
			   ...
			   if( $postData  == false ){
				   ...
				   $replace = array( esc_attr( $response['first_name'] ), esc_attr( $response['last_name'] ) , $amount , date("F jS, Y", strtotime( $temp ) ) , '<br>'  );
	...
	{   	
		 ...
		 $firstname = ''; $lastname = ''; $date = ''; $amount  = '';	
		  ...
		  //$page =  $_GET['thanks'] .'-'.  $_POST['thanks'] .'-'. $_GET['id'] .'-'. $_POST['id'];
			...
			$placeholder = array( '[firstname]','[lastname]' ,'[amount]' ,'[date]' , '[newline]' );				   
			$replace = array( $firstname , $lastname , $amount , date("F jS, Y", strtotime( $date ) ) , '<br>'  );
