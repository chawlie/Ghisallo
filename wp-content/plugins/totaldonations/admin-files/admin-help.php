...
/********** User access start here ***************/
  ...
  $level = 10;
  echo "<div class='col-md-6 col-lg-6 col-xl-12'><section class='panel panel-featured-left panel-featured-primary'><div class='panel-body'><h2 class='panel-title'>Grant User Access <span class='panel-subtitle'>All Users other than administers will not be able to change user access.</span></h2>";
