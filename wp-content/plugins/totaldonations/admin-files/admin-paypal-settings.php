...
echo "<div class='col-sm-12'>";
		echo "<section class='panel'><header class='panel-heading'><div class='panel-actions'><a class='fa fa-caret-down' data-toggle='collapse' data-parent='.panel' href='#collapseTwo' aria-expanded='true'></a></div><h2 class='panel-title'><i class='fa fa-paypal'></i>". __("PayPal Standard Settings","migla-donation"). "</h2></header>";
		echo "<div id='collapseTwo' class='panel-body collapse in'>";
	
		echo "<div class='row div_paypal_std'><div class='col-sm-3'><label for='miglaPaypalEmails' class='control-label text-right-sm text-center-xs'>". __("Business Email","migla-donation"). "</label></div><div class='col-sm-6 col-xs-12'>";
...
$ipn = get_option('migla_ipn_choice');
 ...
 { 
    ...
    $ipn = get_option('migla_ipn_choice'); 
		...
		echo "<div class='row'><div class='col-sm-3'><label for='migla_ipn_choice' class='control-label text-right-sm text-center-xs'>". __("Use the IPN listener on the frontend ?","migla-donation"). "</label></div><div class='col-sm-9 col-xs-12'>";
if( $ipn == 'front' ){
  ...
  echo "<label class='checkbox-inline' for='migla_ipn_choice'><input type='checkbox' id='migla_ipn_choice' name='migla_ipn_choice' class=''><em>". __("Warning: ","migla-donation"). "</em> ". __(" Check this only if need to use the IPN listener on the frontend. See the documentation for details ","migla-donation"). "</label></div>";
   ...
   $listenerfront = esc_url( add_query_arg( 'migla_listener', 'IPN', home_url( 'index.php' ) ) );
		...
		echo "<div class='row'><div class='col-sm-3'><label for='miglaPaypalListener' class='control-label text-right-sm text-center-xs'>". __("IPN Listener:","migla-donation"). "</label></div><div class='col-sm-9 col-xs-12'>";
   if( $ipn == 'front' ){
   ...
   echo "</div>";    
		...
		echo "<div class='row'><div class='col-sm-3'><label for='migla_ipn_chatback' class='control-label text-right-sm text-center-xs'>". __("IPN ChatBack:","migla-donation"). "</label></div><div class='col-sm-9 col-xs-12'>";
...
echo "<label for='miglaPaypalSendFEC' class='control-label text-right-sm text-center-xs'>". __("Send FEC Data to PayPal STD:","migla-donation"). "</label></div>";
...
<div class='radio'>
														<label>
															<input type='radio' id='mg_sandbox' name='miglaPaypal' value='sandbox' ".$payment['sandbox']." >". __("Sandbox PayPal","migla-donation"). "</label>
													</div>
